...
(function () {
  ...
  angular
    .module('WeViews')
    .controller('TserviceAssigndocumentBatchController', TserviceAssigndocumentBatchController);
  function TserviceAssigndocumentBatchController($rootScope,$uibModalInstance,Message,CustomerService,$scope,woIds) {
    var vm = this;
    vm.requesting=false;
