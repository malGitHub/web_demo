(function () {
  ...
  angular.module('WeViews')
    .controller('TserviceActivitiesnewImportController', TserviceActivitiesnewImportController);

  function TserviceActivitiesnewImportController($rootScope,$uibModalInstance,TbossService, ActivityListService,id,carChassisNumList, Message,$timeout) {
    var vm = this;
    vm.file = null;
    vm.cancel = function () {
