...
(function () {
  ...
  angular.module('WeViews')
    .controller('TserviceActivitiesnewtwoPhoneController', TserviceActivitiesnewtwoPhoneController);

  function TserviceActivitiesnewtwoPhoneController($uibModalInstance,carChassisNumErrList,carChassisNumList) {
    var vm = this;
    //查看非法号码原因
