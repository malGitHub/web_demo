(function () {
  ...
  angular.module('WeViews')
    .controller('TserviceMessagechitsendImportController', TserviceMessagechitsendImportController);

  function TserviceMessagechitsendImportController($rootScope,$uibModalInstance, TbossService, Message,title,content,userPhoneNumbers,$timeout) {
    var vm = this;
    vm.file = null;
    vm.cancel = function () {
