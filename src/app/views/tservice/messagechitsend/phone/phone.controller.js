...
(function () {
  ...
  angular.module('WeViews')
    .controller('TserviceMessagechitsendPhoneController', TserviceMessagechitsendPhoneController);

  function TserviceMessagechitsendPhoneController($uibModalInstance,userPhoneNumbersErr,userPhoneNumbers) {
    var vm = this;
    //查看非法号码原因
